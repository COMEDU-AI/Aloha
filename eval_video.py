...
STYLE_TRANSFORM_PATH = "weights/transformer_weight_style5.pth"
PRESERVE_COLOR = False

def style_transfer(net_style, img):
...
def parse_args(argv=None):
    ...
    parser.add_argument('--trained_model',
                        default='weights/yolact_plus_base_140_400000.pth', type=str,
...
def prep_display(dets_out, img, h, w, undo_transform=True, class_color=False, mask_alpha=0.45, fps_str=''):
    ...
    if args.display_masks and cfg.eval_mask_branch and num_dets_to_consider > 0:
        ...
        style_image = torch.Tensor(style_transfer(net_style, img.detach().cpu().numpy())).cuda()
